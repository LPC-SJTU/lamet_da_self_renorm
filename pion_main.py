...
def pion_main():
    ...
    pion_mom_6 = MESON_DA_HYB(meson, 6, x_ls, x_ls_matching, y_ls_matching, extend_point['mom=6'], extend_fit_start['mom=6'], t_dic['mom=6'], gs_extract=True, fit_1=True, fit_2=False, rotate=True, lcda_fit=lcda_fit, constant_fit=constant_fit)
    ...
    # pion_mom_10 = MESON_DA_HYB(meson, 10, x_ls, x_ls_matching, y_ls_matching, extend_point['mom=10'], extend_fit_start['mom=10'], t_dic['mom=10'], gs_extract=True, fit_1=False, fit_2=False, rotate=True, lcda_fit=lcda_fit, constant_fit=constant_fit)
