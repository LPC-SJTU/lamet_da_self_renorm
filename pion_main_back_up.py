...
def pion_main():
    ...
    # pion_mom_6 = MESON_DA_HYB(meson, 6, x_ls, x_ls_matching, y_ls_matching, extend_point['mom=6'], extend_fit_start['mom=6'], t_dic['mom=6'], gs_extract=False, fit_1=False, matching=False, fit_2_quasi=False, fit_2_lc=True, rotate=True, lcda_fit=lcda_fit, constant_fit=constant_fit)
    # mom_6_quasi_da, mom_6_lic_da = pion_mom_6.main(zR_dic)
    # gv.dump(mom_6_lic_da, 'pion/mom=6/mom_6_lic_da')
    # quasi_vs_lc_plot(x_ls, x_ls, mom_6_quasi_da, mom_6_lic_da, pz=1.29, meson='pion')
    # y_ls = x_ls
    ...
    # pion_mom_8 = MESON_DA_HYB(meson, 8, x_ls, x_ls_matching, y_ls_matching, extend_point['mom=8'], extend_fit_start['mom=8'], t_dic['mom=8'], gs_extract=False, fit_1=False, matching=False, fit_2_quasi=False, fit_2_lc=True, rotate=True, lcda_fit=lcda_fit, constant_fit=constant_fit)
    # mom_8_quasi_da, mom_8_lic_da = pion_mom_8.main(zR_dic)
    # gv.dump(mom_8_lic_da, 'pion/mom=8/mom_8_lic_da')
    # quasi_vs_lc_plot(x_ls, x_ls, mom_8_quasi_da, mom_8_lic_da, pz=1.72, meson='pion')
    # y_ls = x_ls
    ...
    pion_mom_10 = MESON_DA_HYB(meson, 10, x_ls, x_ls_matching, y_ls_matching, extend_point['mom=10'], extend_fit_start['mom=10'], t_dic['mom=10'], gs_extract=False, fit_1=False, matching=False, fit_2_quasi=False, fit_2_lc=True, rotate=True, lcda_fit=lcda_fit, constant_fit=constant_fit)
    mom_10_quasi_da, mom_10_lic_da = pion_mom_10.main(zR_dic)
    gv.dump(mom_10_lic_da, 'pion/mom=10/mom_10_lic_da')
    quasi_vs_lc_plot(x_ls, x_ls, mom_10_quasi_da, mom_10_lic_da, pz=2.15, meson='pion')
    y_ls = x_ls
    ...
    # ############################
    # large_mom_lic_da = large_mom_limit(x_ls, mom_6_lic_da, mom_8_lic_da, mom_10_lic_da, mom_ls=[6, 8, 10], meson=meson)
    ...
    # lcda_large_pz_plot(meson, x_ls, mom_10_lic_da, large_mom_lic_da)
